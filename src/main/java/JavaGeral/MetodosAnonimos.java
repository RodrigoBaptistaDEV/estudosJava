 ...
 * Métodos Anônimos - Lambdas e Classes
 *
 * métodos anônimos referem-se a métodos que não possuem um nome específico e são geralmente utilizados
 * em contexto de programação funcional, particularmente em expressões lambda e classes anônimas.
 *
 * o Java tem um conceito de "métodos anônimos" na forma de expressões lambda e classes anônimas.
 * Embora tecnicamente não sejam "métodos anônimos" no sentido estrito, eles permitem a criação
 * de blocos de código que se comportam como métodos, mas sem a necessidade de um nome explícito.
 */

// Expressões Lambda

/*
 * Introduzidas no Java 8, as expressões lambda permitem definir métodos anônimos de forma concisa,
...
public class MetodosAnonimos {
    public static void main(String[] args) {
         ...
         * public class Main {
         *     public static void main(String[] args) {
         *         // Usando uma expressão lambda para definir o método 'executar'
         *         Operacao soma = (a, b) -> a + b;
...
class ExemploClasseAnonima {
    public static void main(String[] args) {
        ...
        /*
         * Antes do Java 8, uma forma comum de criar comportamentos similares a métodos anônimos
 ...
 *
 * Ambas as abordagens permitem a criação de blocos de código que se comportam como métodos sem
 * a necessidade de um nome explícito para o método em si.
 */
 ...
 *
 * Classes Anônimas permitem maior flexibilidade, pois podem implementar múltiplos métodos
 * (se a classe ou interface permitir) e manter estado, mas resultam em código mais verboso.
 * Úteis quando precisamos de mais flexibilidade, como ter mais de um método ou acessar variáveis de instância.
 *
...
class ExemplosLambdaAvancados {
    public static void main(String[] args) {
        /*
         * Expressões lambda são uma maneira concisa de expressar métodos anônimos (sem nome) em Java.
         * Elas são usadas principalmente para implementar interfaces funcionais, que têm apenas um método abstrato.
         *
         * Aqui está uma explicação passo a passo:
         */

        // Interfaces Funcionais
        // Em Java, uma interface funcional é uma interface que contém apenas um método abstrato.
...
class ContextosUsoLambdas {
    public static void main(String[] args) {
         ...
         * Uma interface funcional é aquela que contém exatamente um método abstrato.
